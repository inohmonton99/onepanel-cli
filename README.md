...
Jobs run in different containers as against workspaces, jobs automatically pulls out the latest code when ran, jobs can run in parallel which is very efficient when testing different parameters.  
